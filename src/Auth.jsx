...
export default function App() {
  ...
  return (
    <div style={{ background: '#f8fafc', minHeight: '100vh' }}>
      <nav style={{ padding: '15px 5%', background: '#fff', borderBottom: '1px solid #e2e8f0' }}>
        <div style={{fontWeight:'900', fontSize:'20px', color:'#1e293b'}}>ProjectFlow <span style={{fontSize:'10px', background:'#fefce8', color:'#854d0e', padding:'2px 8px', borderRadius:'4px', marginLeft:'10px'}}>ADMIN MODE</span></div>
      </nav>
        ...
        <div style={modalOverlay}>
          <div style={modalContent}>
            ...
            <form onSubmit={handleCreateProject} style={formBody}>
              ...
              <div style={sectionLabel}>Project Site</div>
              <div style={grid2}>
...
const modalContent = { background:'#fff', width:'500px', borderRadius:'20px', overflow:'hidden' };
